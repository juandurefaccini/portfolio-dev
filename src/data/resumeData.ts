...
export const softSkills = [
  ...
  {
    name: "Comunicar",
    description: "Experiencia en comunicación con clientes para presentar avances.",
  },
  {
    name: "Presupuestar",
    description: "Experiencia en la definición de presupuestos para proyectos de desarrollo de software.",
  },
];
...
export const experience = [
  {
    ...
    details: [
      {
        title: "Zenova",
        description: "Consultora de desarrollo de software. Fuí responsable de crear la landing page",
      ...
      {
        title: "Hermes",
        description: "Agencia de asistentes con inteligencia artificial. Fui responsable de crear el branding, la landing page y el desarrollo del producto, además de generar demostraciones para potenciales clientes, lo que resultó clave para atraer interesados.",
      ...
      {
        title: "Venom Store",
        description: "Desarrollo de una tienda de ecommerce con punto de venta. El proyecto fue redirigido a una plataforma de tienda nube por cambios en los requerimientos del cliente.",
        technologies: ["React", "Tailwind CSS"],
        tags: ["E-Commerce", "Punto de Venta"],
      },
      {
        title: "Tracking de lactancia",
        description: "Desarrollé una plataforma para llevar registro de la lactancia de una madre, y así evitar el uso de documentos papel. Este proyecto facilitó la vida de la madre y permitió un seguimiento más detallado de la alimentación del bebé.",
        technologies: ["React", "Tailwind CSS"],
  ...
  },
  {
    ...
    details: [
      ...
      },
      {
        ...
        description: "Presupuesté y desarrollé una aplicación en React Native, mejorando el código y añadiendo funcionalidades como reproducción de videos con Chromecast para iOS y Android, listas de favoritos, diseño responsive y descarga de videos para reproducción offline.",
  ...
  },
  {
    ...
    details: [
      {
        title: "Sistema ERP",
        description: "Realicé tareas de mantenimiento y mejoras para diferentes sistemas ERP. Implementé mejoras en el frontend, base de datos y backend, contribuyendo a optimizar el rendimiento y la usabilidad de los sistemas. Generación de API Rest. En ciertos casos participé en la comunicación con los clientes para la toma de requerimientos y el informe de avances.",
    ...
    details: [
      {
        ...
        description: "Participé en el desarrollo temprano de My Ice Cream Journey, un videojuego mobile. Contribuí con el diseño de interfaces visuales, la lógica de game design y la implementación del prototipo. El juego fué lanzado en la Play Store pero actualmente no se encuentra disponible.",
